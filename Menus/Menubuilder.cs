...
public class Menubuilder
{
    ...
    public string Run2(List<string> menuItems)
    {
        ...
        while (true)
        {
            ...
            {
                // Flytta upp markören
                currentSelection = (currentSelection == 0) ? menuItems.Count - 1 : currentSelection - 1;
            }
            else if (key.Key == ConsoleKey.DownArrow)
            {
                // Flytta ner markören
                currentSelection = (currentSelection == menuItems.Count - 1) ? 0 : currentSelection + 1;
            }
            else if (key.Key == ConsoleKey.Enter)
            {
